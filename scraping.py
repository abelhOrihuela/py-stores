...
request = requests.get(
    "https://www.elsoldetoluca.com.mx/policiaca/asesinan-a-un-hombre-en-metepec-4889260.html"
)
...
elements_tags = html.select(
    "body > div.container > section > section > div.tags-list > ul > li"
)
contents = ""
tagsText = ""
tagsArray = []
